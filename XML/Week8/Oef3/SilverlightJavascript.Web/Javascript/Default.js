...
function oef3(sender, mouseEventArgs) {
    var rootElement = defaultPage.content.findName('canvas');
    
   if (mouseEventArgs.getPosition(sender).x < (sender.width / 2)) {
       var xamlFragmentEllips1 = '<Ellipse Name="ellipse1" Visibility="visible" Width="100"  Height="100"  Fill="Red" Canvas.Left="0" Canvas.Top="50" />';
       rootElement.children.add(defaultPage.content.createFromXaml(xamlFragmentEllips1));
   } else {
       var xamlFragmentEllips2 = '<Ellipse Name="ellipse2" Visibility="visible" Width="100"  Height="100"  Fill="Red" Canvas.Left="500" Canvas.Top="50" />';
